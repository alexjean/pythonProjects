...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_3.setGeometry(QtCore.QRect(570, 10, 81, 16))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit.setText(_translate("Dialog", "Terminal"))
        ...
        self.label_3.setText(_translate("Dialog", "com.apple"))
        self.label.setText(_translate("Dialog", "In Dir :     home   /"))
        self.comboDir.setItemText(0, _translate("Dialog", "Preferences"))
        self.comboDir.setItemText(1, _translate("Dialog", "electron11/src"))
